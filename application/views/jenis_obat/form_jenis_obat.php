<div class="col-md-12">
    ...
    <form method="post" action="<?= base_url()?>jenis_obat/simpan" class="form-horizontal">
        <div class="box-body">
        <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Id Jenis Obat</label>
            <div class="col-sm-10">
            <input type="text" name="id_jenis_obat" value="<?= $id_jenis_obat ?>" class="form-control" readonly>
            </div>
        </div>
